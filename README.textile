...
*** @export ALLOY_UI="/liferay/github/alloy-ui";@
*** @export LIFERAY_BUNDLE="/liferay/bundles/liferay-portal-trunk";@
*** @export LIFERAY_GIT="/liferay/github";@
*** @export LIFERAY_PLUGINS="/liferay/github/liferay-plugins";@
*** @export LIFERAY_PLUGINS_EE="/liferay/github/liferay-plugins-ee";@
*** @export LIFERAY_PORTAL="/liferay/github/liferay-portal";@
*** @export LIFERAY_PORTAL_EE="/Volumes/liferay/github/liferay-portal-ee";@
*** @export LIFERAY_TOMCAT="$LIFERAY_BUNDLE/tomcat-7.0.22";@
